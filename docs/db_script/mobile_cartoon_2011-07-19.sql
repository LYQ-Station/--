...
# Generation Time: 2011-07-19 23:36:52 +0800
# ************************************************************
...
CREATE TABLE `acl_group` (
  ...
  `code` binary(32) DEFAULT NULL COMMENT '掩码',
...
INSERT INTO `acl_group` (`id`, `pid`, `path`, `code`, `name`, `notes`)
VALUES
	(1,0,'/1',NULL,'aa','aa'),
	(2,1,'/1/2',NULL,'fff','ffff');
...
VALUES
	('dd669bdfe',1,'admin','admin',1311084739,1311085849,2130706433);
