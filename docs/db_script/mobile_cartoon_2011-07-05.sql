...
# Generation Time: 2011-07-05 23:06:30 +0800
# ************************************************************
...
CREATE TABLE `acl_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='acl权限组';
...
CREATE TABLE `mc_resource` (
  ...
  PRIMARY KEY (`id`),
  KEY `title` (`title`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='资源表';
...
VALUES
	('dd669bdfe',1,'admin','admin',1309872296,1309878356,2130706433);
