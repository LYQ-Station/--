...
# Generation Time: 2011-05-29 18:46:05 +0800
# ************************************************************
...
CREATE TABLE `mc_resource` (
  ...
  PRIMARY KEY (`id`),
  KEY `title` (`title`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='资源表';
...
VALUES
	('dd669bdfe',1,'admin','admin',1306632647,1306665778,2130706433);
